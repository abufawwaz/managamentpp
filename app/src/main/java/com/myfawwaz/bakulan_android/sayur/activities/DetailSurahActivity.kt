package com.myfawwaz.bakulan_android.sayur.activities
...
import com.myfawwaz.bakulan_android.sayur.R
import com.myfawwaz.bakulan_android.sayur.adapter.AyatAdapter
import com.myfawwaz.bakulan_android.sayur.model.ModelAyat
import com.myfawwaz.bakulan_android.sayur.model.ModelOrder
import com.myfawwaz.bakulan_android.sayur.networking.Api
...
class DetailSurahActivity : AppCompatActivity() {
    ...
    var modelOrder: ModelOrder? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        modelOrder = intent.getSerializableExtra("detailOrder") as ModelOrder
        if ( modelOrder  != null) {
            nomor =  modelOrder!!.firstname
            nama =  modelOrder!!.firstname
            arti =  modelOrder!!.firstname
            type = modelOrder!!.firstname
            ayat = modelOrder!!.firstname
            audio = modelOrder!!.firstname
            keterangan = modelOrder!!.firstname
